...
export default function Catalog() {
  ...
  const renderProductCard = (product) => {
    ...
    return (
      ...
      >
        <div
          className={`catalog-card${stockQty <= 0 ? ' sold-out' : ''}`}
        ...
        >
          ...
          >
            ...
            onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(0)'; }}>
              ...
              <button
                onClick={(e) => { e.stopPropagation(); navigate(`/catalog/${product.slug || product._id}`); }}
                title="View product"
                style={{
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .catalog-bar { width: 40px; height: 3px; background: ${C.red}; border-radius: 2px; flex-shrink: 0; }
        .catalog-bar-thin { width: 20px; height: 3px; background: ${C.border}; border-radius: 2px; flex-shrink: 0; }
        .catalog-hero-sub {
          font-family: 'Barlow', sans-serif;
          font-size: 0.9rem;
          font-weight: 400;
        ...
        .catalog-sort-wrap { position: relative; }
        .catalog-sort-btn {
          display: inline-flex;
          align-items: center;
          gap: 7px;
        ...
        .catalog-sort-btn:hover, .catalog-sort-btn.open { border-color: ${C.red}; color: ${C.red}; }
        .catalog-sort-btn svg { transition: transform 0.2s; }
        .catalog-sort-btn.open svg { transform: rotate(180deg); }
        .catalog-sort-menu {
          position: absolute;
          right: 0;
          top: calc(100% + 6px);
        ...
        .catalog-sort-item:last-child { border-bottom: none; }
        .catalog-sort-item:hover { background: ${C.redLight}; color: ${C.red}; padding-left: 18px; }
        .catalog-sort-item.active { color: ${C.red}; font-weight: 600; background: ${C.redLight}; }
        ...
        @media (max-width: 768px) {
          .catalog-hero { padding: 2rem 1.25rem 1.75rem; }
          .catalog-hero-title { font-size: clamp(1.7rem, 8vw, 2.4rem); }
          .catalog-toolbar { padding: 1rem 1.25rem; justify-content: center; }
          .catalog-categories { 
      ...
      <div className="catalog-page">
        ...
        <div className="catalog-hero">
          <div className="catalog-hero-inner">
            ...
            <div className="catalog-title-accent">
              <div className="catalog-bar" />
              <div className="catalog-bar-thin" />
            </div>
            <p className="catalog-hero-sub">Explore our complete collection of premium products</p>
          </div>
        </div>
        ...
        <div className="catalog-toolbar">
          <div className="catalog-sort-wrap">
            <button
              className={`catalog-sort-btn${sortOpen ? ' open' : ''}`}
            ...
            {sortOpen && (
              <div className="catalog-sort-menu">
                {SORT_OPTIONS.map(o => (
                  <button
                    key={o.value}
                    className={`catalog-sort-item${sortOption === o.value ? ' active' : ''}`}
        ...
        <div className="catalog-grid-wrap">
          {loading ? (
            ...
            <div className="text-center my-5 py-5">
              ...
              }}>Try adjusting your filters or check back later for new products.</p>
            </div>
          ) : (
